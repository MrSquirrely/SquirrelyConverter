    ...
    class Toast {
        ...
        internal static void CreateNotifier() {
            _Notifier = new Notifier(cfg => {
                cfg.PositionProvider = new WindowPositionProvider(parentWindow: Utilities._MainWindow, corner: Corner.BottomRight, offsetX: 10, offsetY: 10);
        ...
        internal static void Update() => _Notifier.ShowInformation($"There is an update. Your version: {Utilities._CurrentVersion} Updated version: {Utilities._UpdateVerstion}"); //This message shows when there is an update
